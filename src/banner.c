...
int banner(char *s, struct bann *bufp);
int banner_fill(char *c, struct bann *p);
void banner_set(char c, struct bann *p);
void banner_print(struct bann *ptr);
